...
public struct ErrNo: Error, RawRepresentable, Equatable, Comparable {
	...
	static let ENOEXEC = 8
    /// Bad file descriptor (POSIX.1)
	static let EBADF = 9
    /// No child processes (POSIX.1)
	static let ECHILD = 10
    /// Out of memory (POSIX.1)
	static let ENOMEM = 12
    /// Permission denied (POSIX.1)
	static let EACCES = 13
    /// Bad address (POSIX.1)
	static let EFAULT = 14
    /// Block device required (POSIX.1)
	static let ENOTBLK = 15
    /// Device or resource busy (POSIX.1)
	static let EBUSY = 16
    /// File exists (POSIX.1)
	static let EEXIST = 17
    /// Improper link (POSIX.1)
	static let EXDEV = 18
    /// No such device (POSIX.1)
	static let ENODEV = 19
    /// Not a directory (POSIX.1)
	static let ENOTDIR = 20
    /// Is a directory (POSIX.1)
	static let EISDIR = 21
    /// Invalid argument (POSIX.1)
	static let EINVAL = 22
